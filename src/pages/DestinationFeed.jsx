...
const OffersFeed = () => {
  ...
  const DUMMY_OFFERS = [
    ...
    },
    {
      ...
      price: 6999,
      description: "Unique treehouse accommodation amidst dense forests with wildlife sightings and nature trails.",
    ...
    },
    {
      ...
      price: 1999,
      description: "Learn to cook authentic Kerala Sadhya feast with expert chefs. Includes market tour and recipe book.",
    ...
    },
    {
      ...
      price: 899,
      description: "orchid for sale, orchid for sale in Kerala",
    ...
    },
    {
      ...
      price: 1799,
      description: "Paddle through narrow canals, explore village life, and enjoy bird watching in serene backwaters.",
